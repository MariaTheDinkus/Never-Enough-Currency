...
public class ContainerItem extends Container
{
	 ...
	 */
	private static final int INV_START = InventoryItem.INV_SIZE, INV_END = INV_START + 26, HOTBAR_START = INV_END + 1, HOTBAR_END = HOTBAR_START + 8;
	...
	public ContainerItem(EntityPlayer par1Player, InventoryPlayer inventoryPlayer, InventoryItem inventoryItem)
	{
		...
		for(i = 0; i < InventoryItem.INV_SIZE; ++i)
		{
			...
			this.addSlotToContainer(new SlotWallet(this.getItemInventory(), i, 80 + (18 * (int) (i / 4)), 8 + (18 * (i % 4))));
		}
...
//					{
//						if (CompatLayer.isV10() && ItemStackTools.getStackSize(itemstack1) == 0)
//						{
